...
def datafr():
    df= pd.read_csv("C:\Airbnb\Airbnb2.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("C:\Airbnb\OIP.jpg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab1:
        ...
        with col1:
            ...
            # Select a room type from the filtered data
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:\Airbnb\Airbnb2.csv")
            return df_a
    ...
    with tab3:
        ...
        df_val_sel_corr= df_val_sel.drop(columns=["listing_url","name", "property_type",                 
                                            ...
                                            "images","host_url","host_name",                   
                                            "host_response_time", "host_thumbnail_url",            
                                            "host_response_rate","host_is_superhost","host_has_profile_pic" ,         
                                            "host_picture_url","host_neighbourhood","host_location",
    ...
    with tab5:
        ...
        df_price.sort_values(by="Avarage_price", ascending=False, inplace=True)
        df_price.sort_values(by="Total_price", ascending=False, inplace=True)
        ...
        with col1:
            ...
            df_price_1.sort_values(by="Total_price", ascending=False, inplace=True)
        ...
        with col2:
            df_price_1.sort_values(by="Avarage_price", ascending=False, inplace=True)
